...
from app.crud.jobs import delete_job_by_id
from app.crud.jobs import list_jobs
from app.crud.jobs import retreive_job
from app.crud.jobs import update_job_by_id
...
def read_job(id: int, db: Session = Depends(get_db), current_user: User = Depends(get_current_user_from_token)):
...
def read_jobs(db: Session = Depends(get_db), current_user: User = Depends(get_current_user_from_token)):
